"""
Django settings for cityplay project.
...
SECRET_KEY = 'django-insecure-jm=b64x8@0ty@@i7en2s7j4oaik+6*l)^@f=-k+__xl*-li2t+'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'bookings.context_processors.navbar_booking_count', 
            ],
        },
    },
]

WSGI_APPLICATION = 'cityplay.wsgi.application'
